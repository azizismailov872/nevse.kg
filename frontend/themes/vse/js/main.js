...
$(document).ready(function(){
	...
	//Guest Order form
	$('#guest-order-form').on('afterValidate',function(event,messages,attributes){
	...
	$('#guest-order-form').on('beforeSubmit',function(){
	...
	$.ajax({
		...
		{	
			if(res.result == true)
			{
				...
				$('#guest-order-form input').val("");

				$('#guest-order-form select').val("");
