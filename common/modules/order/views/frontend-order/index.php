...
?>
<h2 class="content-header d-lg-block text-lg-left text-center">Опишите ваш заказ</h2>
...
<div class="row">
    ...
    ])->textarea(['class' => 'order-form-textarea']);?>
</div>
<?= $form->field($model,'category_id',[
    'template' => '
        ...
        <div class="col-lg-4 order-1 pl-lg-2">
            <button class="button green full order-form-button popup-open weight" type="button" id="new-order">Создать заказ</button>
        </div>
...
<div class="popup new-order">
    <div class="popup-content">
        ...
        <div class="popup-body">
            <div class="row">
                <div class="col-12">
                    <h3 class="new-order-header">Контакты</h3>
                </div>
                <div class="col-12">
                    <p class="new-order-text">Введите номер телефона для связи</p>
                </div>
            </div>
            <?= $form->field($model,'author_phone',[
                'template' => '
                    ...
                    <div class="col-12">
                        <button class="button green full new-order-btn weight" id="create-order-btn" type="submit">Создать заказ</button>
                    </div>
                ',
                'options' => [
                    'tag' => 'div',
...
<h3 class="content-header d-lg-block text-lg-left text-center new-cont" style="margin-top: 20px;">Новые заказы</h3>
