...
?>
<h2 class="content-header d-lg-block text-lg-left text-center">Опишите ваш запрос</h2>
...
<?= $form->field($model,'category_id',[
    'template' => '
        ...
        <div class="col-lg-4 order-1 pl-lg-2">
            <button class="button green full order-form-button popup-open" id="new-order">Создать запрос</button>
        </div>
...
<div class="popup new-order">
    <div class="popup-content">
        ...
        <div class="popup-body">
            <div class="row">
                <div class="col-12">
                    <h3 class="new-order-header">Создайте запрос</h3>
                </div>
                <div class="col-12">
                    <p class="new-order-text">Укажите номер телефона, чтобы создать запрос</p>
                </div>
            </div>
...
<?php Pjax::begin(['id' => 'orders-list-pjax']);?>
    ...
    <?php else: ?>
        <div class="no-order">
            <h2 class="no-order-header">Нет запросов в этой категории</h2>
        </div>
    <?php endif;?>
</div>
